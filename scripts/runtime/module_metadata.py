...
from modules.nn import load_mpd_config, load_remiss_config, load_remiss_conv_config, normalize_arch
...
_CONFIG_LOADERS: dict[str, Callable[..., Any]] = {
    ...
    "remiss_conv": load_remiss_conv_config,
    "mpd": load_mpd_config,
}
...
def collect_enabled_module_configs(
    ...
    *,
    ...
    for name in ("remiss", "remiss_conv", "mpd"):
